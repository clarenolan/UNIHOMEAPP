 ...
 *   and
 *   Blogzone
 *   github | https://github.com/kenny-io/Blogzone
 */
...
import com.example.unihomeapp.PropertyDetailViewModel;
...
import static com.example.unihomeapp.R.layout.activity_property_detail;
...
public class PropertyDetail extends AppCompatActivity {
    ...
    ImageView propertyImage, ivWifi, ivBins, ivElectricity, ivHeating, ivTV, ivKitchen, ivWashing, ivDryer, ivParking, ivDish;
    String key = "";
    String imageUrl = "";
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_property_detail);
...
//                });
        ...
        mDatabase.child(property_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String property_desc = (String) snapshot.child("description").getValue();
                ...
                Glide.with(PropertyDetail.this)
...
//    }
    ...
    private void showDialogRating() {
        ...
        //    propertyDetailViewModel.setReviewModel(reviewModel);
...
//            waitingDialog.show();
//            FirebaseDatabase.getInstance().getReference("Saved").child(property_key).push().addValueEventListener(new ValueEventListener() {
//                @Override
//                public void onDataChange(@NonNull DataSnapshot snapshot) {
//                    if (snapshot.child(mAuth.getCurrentUser().getUid()).exists())
//                    {//Remove old value
//                        ratingTable.child(property_key).removeValue();
//                        //Update new value
//                        ratingTable.child(property_key).setValue(reviewModel);
//                    } else{
//                        //Upload new Value
//                        ratingTable.child(property_key).setValue(reviewModel);
//                    }
